...
A personal contact manager that tracks leads using the FORMHD framework (Family, Occupation, Recreation, Money, Hobbies, Dreams) with Excel CSV import/export and auto-generated needs summaries.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "226039880+sunny89lee-cml@users.noreply.github.com"
  git config user.name "sunny89lee-cml"
  ```
